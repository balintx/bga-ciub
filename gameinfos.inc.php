...
'tie_breaker_description' => totranslate("Number of dices on the player board"),
...
'player_colors' => array( "327c41", "ffc800", "cb0800", "1b5288"),
...
'presentation' => array(
    totranslate("Demonstrate your powers at the yearly gathering of magicians. Seek the aid of magical creatures and use the different abilities their dice give you. Find your way with the aid of valuable spell cards and win the crowning achievement of your craft: the Opus Magnum. But never ever underestimate the power of the dice!"),
    totranslate("In each round on Ciúb, you will try to make your dice show the combination on one of the spell cards in order to gain victory points. Different faces on the various dice will aid you. After you gain a spell, you will usually need to reduce the number of your dice, so planning ahead for the next round is key."),
    totranslate("At game end, the player with the most victory points wins!")
