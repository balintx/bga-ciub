 ...
 *        with the same ID (see "initGameStateLabels" in ciub.game.php)
 *
...
$game_options = array(
    ...
    100 => [
        ...
        'values' => [
            1 => ['name' => totranslate('Normal game'), 'description' => totranslate('Game will include Owl cards'), 'nobeginner' => true],
            2 => ['name' => totranslate('Short game'), 'description' => totranslate('Game will not include Owl cards')],
        ],
        'default' => 1
    ]
